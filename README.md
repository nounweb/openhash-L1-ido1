# ⛓ OpenHash Ido1-dong Node

![Layer](https://img.shields.io/badge/Layer-1-green)
...
| 항목 | 값 |
|---|---|
| Node ID | `KR-JEJU-JEJU-IDO1` |
| Layer | L1 — Ido1-dong |
| Endpoint | `https://nounweb.github.io/openhash-L1-ido1` |
...
curl -X POST \
  ...
  https://api.github.com/repos/nounweb/openhash-L1-ido1/dispatches \
  -d '{
